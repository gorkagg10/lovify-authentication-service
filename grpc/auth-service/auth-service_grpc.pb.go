...
func (c *authServiceClient) RegisterUser(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *authServiceClient) Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedAuthServiceServer) RegisterUser(context.Context, *RegisterRequest) (*emptypb.Empty, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lovify_auth_service.AuthService",
	...
	Metadata: "grpc/auth-service/auth-service.proto",
}
